...
G4double Matrix_ref[NUMENTRIES_water] =
 ...
 ///////////////////construct geometry/////////////////////
  ...
  G4Box *solidmPMT = new G4Box("solidmPMT", 3.5*m, 3.5*m, 3.5*m);
  ...
  G4double zPlanesCylinder[3] = {-198.17*mm, -42.6, 69.4*mm};
  G4double rInnerCylinder[3] = {0, 0, 0};
  G4double rOuterCylinder[3] = {255.5*mm, 255.5*mm, 255.3*mm};
  G4Polycone* mPMTAirSolid = new G4Polycone("mPMTAirSolid",
					    0,
					    2 * M_PI,
					    3,
					    zPlanesCylinder,
  ...
  G4double checkdomeInnerRadius = 347.*mm;
  G4double checkdomeOuterRadius = 500.*mm;

  G4Sphere *checkdomeSphere = new G4Sphere("checkDomeSphere",
                                      checkdomeInnerRadius,
                                      checkdomeOuterRadius,
                                      0.0*deg, 360.0*deg,
                                      0.0, 90.*deg);

  G4Box *checksolidBoxCutOut = new G4Box("checkBoxCutOut",
                                    checkdomeOuterRadius+1.*cm,
                                    checkdomeOuterRadius+1.*cm,
                                    235*mm);

  G4SubtractionSolid *checkdomeSolid = new G4SubtractionSolid("checkdomeSolid",
                                               checkdomeSphere,
                                               checksolidBoxCutOut);


  G4VSolid* checksubtractionWorld = new G4SubtractionSolid("domeSolidWorld",
                                                      mPMTAirSolid,
                                                      checkdomeSolid,
                                                      0,
                                                      G4ThreeVector(0,0,-277.6*mm));

  G4LogicalVolume*  mPMTAirLogic = new G4LogicalVolume(//mPMTAirSolid,
						       checksubtractionWorld,
						       Air,
						       "mPMTAirLogic");

  
  G4VPhysicalVolume *mPMTAirphys = new G4PVPlacement(0,
						     G4ThreeVector(0.,0.,0.),
						     mPMTAirLogic,
						     "mPMTAirPhys",
						     logicmPMT,
