...
void WCSimOpticalPhysics::ConstructProcess()
{
  ...
  //  fScintillationProcess->SetScintillationYieldFactor(fYieldFactor);  //CHECK BY MOHIT
  //  fScintillationProcess->SetScintillationExcitationRatio(fExcitationRatio); //CHECK BY MOHIT 
...
*/
void WCSimOpticalPhysics::SetScintillationYieldFactor(G4double) {
  // Removed in Geant4 v11.x — no-op
}

void WCSimOpticalPhysics::SetScintillationExcitationRatio(G4double) {
  // Removed in Geant4 v11.x — no-op
}//CHECK BY MOHIT
