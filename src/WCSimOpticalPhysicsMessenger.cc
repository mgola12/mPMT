...
// Modified: Mohit Gola 10 July 2023
//----------------------------------------------------------------------------
//
...
WCSimOpticalPhysicsMessenger::WCSimOpticalPhysicsMessenger(
  ...
  : G4UImessenger(),
    ...
    fActivateProcessCmd(NULL),
    fVerboseCmd(NULL),
    fTrackSecondariesFirstCmd(NULL),

    fCerenkovMaxPhotonsCmd(NULL),
    fCerenkovMaxPhotons1Cmd(NULL),
    fCerenkovMaxBetaChangeCmd(NULL),
    fCerenkovMaxBetaChange1Cmd(NULL),
    fCerenkovStackPhotonsCmd(NULL),
    fCerenkovStackPhotons1Cmd(NULL),
    fCerenkovTrackSecondariesFirstCmd(NULL),
    fCerenkovVerbosityCmd(NULL),

    fScintYieldFactorCmd(NULL),
    fScintYieldFactor1Cmd(NULL),
    fScintByParticleTypeCmd(NULL),
    fScintByParticleType1Cmd(NULL),
    fScintTrackInfoCmd(NULL),
    fScintTrackInfo1Cmd(NULL),
    fScintStackPhotonsCmd(NULL),
    fScintStackPhotons1Cmd(NULL),
    fScintTrackSecondariesFirstCmd(NULL),
    fScintFiniteRiseTimeCmd(NULL),
    fScintFiniteRiseTime1Cmd(NULL),
    fScintVerbosityCmd(NULL),

    fWLSTimeProfileCmd(NULL),
    fWLSTimeProfile1Cmd(NULL),
    fWLSVerbosityCmd(NULL),

    fBoundaryInvokeSDCmd(NULL),
    fBoundaryInvokeSD1Cmd(NULL),
    fBoundaryVerbosityCmd(NULL),

    fAbsorptionVerbosityCmd(NULL),
    fRayleighVerbosityCmd(NULL),
    fMieVerbosityCmd(NULL)
